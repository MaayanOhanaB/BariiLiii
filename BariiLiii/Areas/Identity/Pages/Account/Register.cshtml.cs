...
namespace BariiLiii.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new BariiLiiiUser { FullName = Input.FullName, UserName = Input.Email, Gender=Input.Gender,Uid=Input.Uid, Location=Input.Location, Email = Input.Email };

                var patient = new Patient {PatientId=Input.uId, FullName = user.FullName, PatientNumber = user.Id, Gender = Input.Gender, Location = Input.Location };
